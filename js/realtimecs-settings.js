...
const translations = {
    en: {
        ...
        paymentEnabledText: 'Payment settings are enabled and configured.',
        paymentNotConfiguredText: 'Payment settings are not yet configured. Please fill out the form below.',
        ...
        paymentTab: 'Payment',
        paymentConfigTitle: 'Payment Settings',
        paymentConfigDesc: 'Configure store bank account and contact information.',
        bankDetailsTitle: 'Store Bank Account Details',
    ...
    vi: {
        ...
        paymentConfigTitle: 'Cài đặt thanh toán',
        paymentConfigDesc: 'Cấu hình tài khoản ngân hàng và thông tin liên lạc của cửa hàng.',
        bankDetailsTitle: 'Chi tiết tài khoản ngân hàng của cửa hàng',
        bankNameLabel: 'Tên ngân hàng',
        bankBranchLabel: 'Chi nhánh ngân hàng',
        ...
        storeEmailLabel: 'Địa chỉ email',
        storeAddressLabel: 'Địa chỉ thực tế',
        savePaymentText: 'Lưu cài đặt thanh toán',
        paymentSaveSuccess: 'Đã lưu cài đặt thanh toán thành công!',
        paymentEnabledText: 'Cài đặt thanh toán đã được bật và định cấu hình.',
        paymentNotConfiguredText: 'Cài đặt thanh toán chưa được định cấu hình. Vui lòng điền vào biểu mẫu bên dưới.',
...
function setLanguage(lang) {
    ...
    document.getElementById('payment-tab-text').textContent = t.paymentTab;
    ...
    document.getElementById('store-email-label').textContent = t.storeEmailLabel;
    document.getElementById('store-address-label').textContent = t.storeAddressLabel;
    document.getElementById('save-payment-text').textContent = t.savePaymentText;
}
...
async function savePaymentSettings() {
    ...
    try {
        ...
        if (response.ok) {
            const result = await response.json();
            showNotification('paymentSaveSuccess', 'success');
            console.log('Payment Settings Response:', result);
        } else {
            throw new Error(`HTTP error! status: ${response.status}`);
        }

    ...
    if (btnSetupTrial) {
      ...
      btnSetupTrial.addEventListener('click', function() {
        const actionData = {
            ...
            type: "act_dm_view",
            label: "no label",
            screen: "fusesell-ai-fusesell-ai00-fusesell-ai00obj1-screen_1001",
            alias: "fusesell-ai_fusesell-ai00obj1",
    ...
    if (orgInfoButton) {
        orgInfoButton.addEventListener('click', function() {
            const actionData = {
                ...
                type: "act_dm_view",
                label: "no label",
                screen: "fusesell-ai-fusesell-ai00-fusesell-ai00obj1-screen_1002",
                alias: "fusesell-ai_fusesell-ai00obj1"
